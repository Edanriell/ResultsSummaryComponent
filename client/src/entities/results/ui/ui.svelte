...
<article class={css`
	...
	{#if summaryResult}
		<div
			style="background: {resultComponentBackgroundColor}"
			class={css`
			...
			`}>
			<h2
				style="color: {resultComponentTextColorAccent}"
				class={css`
			...
			`}>
				...
				`}>
					<p
						style="color: {resultComponentTextColorMain}"
						class={css`
							font-family: var(--font-family), sans-serif;
							font-weight: 800;
							font-size: 56px;
